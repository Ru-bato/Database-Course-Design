...
var _default = exports.default = {
  ...
  watch: {
    ...
    __propsSymbol__() {
      ...
      const spec = (0, _extends2.default)((0, _extends2.default)({
        listRef: this.list,
        trackRef: this.track
      }, nextProps), this.$data);
  ...
  mounted() {
    this.__emit('init');
    if (this.lazyLoad) {
      const slidesToLoad = (0, _innerSliderUtils.getOnDemandLazySlides)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data));
    ...
    this.$nextTick(() => {
      const spec = (0, _extends2.default)({
        listRef: this.list,
        trackRef: this.track,
      ...
      this.ro = new _resizeObserverPolyfill.default(() => {
        if (this.animating) {
  ...
  methods: {
    ...
    onWindowResized(setTrackStyle) {
      ...
      this.debouncedResize = (0, _debounce.default)(() => this.resizeWindow(setTrackStyle), 50);
    ...
    ssrInit() {
      ...
      if (this.variableWidth) {
        ...
        const preClones = (0, _innerSliderUtils.getPreClones)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data), {
          slideCount: children.length
        }));
        const postClones = (0, _innerSliderUtils.getPostClones)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data), {
          slideCount: children.length
        }));
      ...
      const spec = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data), {
      ...
      let trackLeft = -slideWidth * ((0, _innerSliderUtils.getPreClones)(spec) + this.currentSlide) * trackWidth / 100;
      if (this.centerMode) {
    ...
    progressiveLazyLoad() {
      const slidesToLoad = [];
      const spec = (0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data);
      for (let index = this.currentSlide; index < this.slideCount + (0, _innerSliderUtils.getPostClones)(spec); index++) {
        if (this.lazyLoadedList.indexOf(index) < 0) {
          slidesToLoad.push(index);
          break;
        }
      }
      for (let index = this.currentSlide - 1; index >= -(0, _innerSliderUtils.getPreClones)(spec); index--) {
        if (this.lazyLoadedList.indexOf(index) < 0) {
          slidesToLoad.push(index);
          break;
        }
    ...
    slideHandler(index) {
      ...
      const {
        state,
        nextState
      } = (0, _innerSliderUtils.slideHandler)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({
        index
      }, this.$props), this.$data), {
        trackRef: this.track,
    ...
    keyHandler(e) {
      const dir = (0, _innerSliderUtils.keyHandler)(e, this.accessibility, this.rtl);
    ...
    swipeStart(e) {
      ...
      const state = (0, _innerSliderUtils.swipeStart)(e, this.swipe, this.draggable);
      state !== '' && this.setState(state);
    },
    swipeMove(e) {
      const state = (0, _innerSliderUtils.swipeMove)(e, (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data), {
        trackRef: this.track,
        listRef: this.list,
    ...
    swipeEnd(e) {
      const state = (0, _innerSliderUtils.swipeEnd)(e, (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, this.$props), this.$data), {
        trackRef: this.track,
        listRef: this.list,
        slideIndex: this.currentSlide
      }));
  ...
  render() {
    const className = (0, _classNames.default)('slick-slider', this.$attrs.class, {
    ...
    if (this.dots === true && this.slideCount >= this.slidesToShow) {
      let dotProps = (0, _innerSliderUtils.extractObject)(spec, ['dotsClass', 'slideCount', 'slidesToShow', 'currentSlide', 'slidesToScroll', 'clickHandler', 'children', 'infinite', 'appendDots']);
    ...
    const arrowProps = (0, _innerSliderUtils.extractObject)(spec, ['infinite', 'centerMode', 'currentSlide', 'slideCount', 'slidesToShow']);
    ...
    const listStyle = (0, _extends2.default)((0, _extends2.default)({}, verticalHeightStyle), centerPaddingStyle);
    ...
    let listProps = {
      ...
      [_supportsPassive.default ? 'onTouchstartPassive' : 'onTouchstart']: touchMove ? this.swipeStart : noop,
      [_supportsPassive.default ? 'onTouchmovePassive' : 'onTouchmove']: this.dragging && touchMove ? this.swipeMove : noop,
