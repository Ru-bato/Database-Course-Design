...
const genFormStyle = token => {
  ...
  return {
    [token.componentCls]: (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _style.resetComponent)(token)), resetForm(token)), {
      [`${componentCls}-text`]: {
      ...
      // =                             Size                             =
      // ================================================================
      '&-small': (0, _extends2.default)({}, genFormSize(token, token.controlHeightSM)),
      '&-large': (0, _extends2.default)({}, genFormSize(token, token.controlHeightLG))
    })
  };
};
const genFormItemStyle = token => {
  ...
  return {
    [formItemCls]: (0, _extends2.default)((0, _extends2.default)({}, (0, _style.resetComponent)(token)), {
      marginBottom: token.marginLG,
      verticalAlign: 'top',
      '&-with-help': {
        transition: 'none'
