...
const genBaseStyle = (prefixCls, token) => {
  ...
  return {
    [treeCls]: (0, _extends2.default)((0, _extends2.default)({}, (0, _style2.resetComponent)(token)), {
      ...
      [`&-focused:not(:hover):not(${treeCls}-active-focused)`]: (0, _extends2.default)({}, (0, _style2.genFocusOutline)(token)),
      // =================== Virtual List ===================
      ...
      // >>> Switcher
      [`${treeCls}-switcher`]: (0, _extends2.default)((0, _extends2.default)({}, getSwitchStyle(prefixCls, token)), {
        position: 'relative',
        flex: 'none',
        alignSelf: 'stretch',
        width: treeTitleHeight,
