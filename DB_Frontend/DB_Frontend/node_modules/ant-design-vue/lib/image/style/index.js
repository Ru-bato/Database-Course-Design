...
const genImageMaskStyle = token => {
  ...
  return {
    ...
    [`.${prefixCls}-mask-info`]: (0, _extends2.default)((0, _extends2.default)({}, _style2.textEllipsis), {
...
const genPreviewOperationsStyle = token => {
  ...
  return {
    [`${previewCls}-operations`]: (0, _extends2.default)((0, _extends2.default)({}, (0, _style2.resetComponent)(token)), {
      display: 'flex',
...
const genImagePreviewStyle = token => {
  ...
  return [{
    [`${componentCls}-preview-root`]: {
      ...
      [`${previewCls}-body`]: (0, _extends2.default)((0, _extends2.default)({}, genBoxStyle()), {
        overflow: 'hidden'
      }),
      [`${previewCls}-img`]: {
        maxWidth: '100%',
        ...
        userSelect: 'none',
        pointerEvents: 'auto',
        '&-wrapper': (0, _extends2.default)((0, _extends2.default)({}, genBoxStyle()), {
          transition: `transform ${motionDurationSlow} ${motionEaseOut} 0s`,
