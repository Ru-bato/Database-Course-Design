  ...
  return {
    [componentCls]: {
      [`&-status-error${componentCls}`]: {
        ...
        '&-focused, &:focus': (0, _extends2.default)({}, (0, _style.genActiveStyle)((0, _internal.mergeToken)(token, {
...
const genPickerStyle = token => {
  ...
  return [{
    [componentCls]: (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _style2.resetComponent)(token)), genPikerPadding(token, controlHeight, fontSize, inputPaddingHorizontal)), {
      position: 'relative',
      display: 'inline-flex',
      alignItems: 'center',
      background: colorBgContainer,
      ...
      '&:hover, &-focused': (0, _extends2.default)({}, (0, _style.genHoverStyle)(token)),
      ...
      // Size
      '&-large': (0, _extends2.default)((0, _extends2.default)({}, genPikerPadding(token, controlHeightLG, fontSizeLG, inputPaddingHorizontal)), {
        [`${componentCls}-input > input`]: {
          fontSize: fontSizeLG
        }
      }),
      '&-small': (0, _extends2.default)({}, genPikerPadding(token, controlHeightSM, fontSize, inputPaddingHorizontalSM)),
      [`${componentCls}-suffix`]: {
        display: 'flex',
        flex: 'none',
        alignSelf: 'center',
      ...
      // ======================= Dropdown =======================
      '&-dropdown': (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _style2.resetComponent)(token)), genPanelStyle(token)), {
        position: 'absolute',
        ...
        [`${componentCls}-range-arrow`]: (0, _extends2.default)({
          position: 'absolute',
          zIndex: 1,
          display: 'none',
        ...
        [`${componentCls}-panel-container`]: {
          ...
          [`${componentCls}-presets`]: {
            ...
            ul: {
              ...
              li: (0, _extends2.default)((0, _extends2.default)({}, _style2.textEllipsis), {
                borderRadius: borderRadiusSM,
