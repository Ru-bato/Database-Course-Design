...
const genModalMaskStyle = token => {
  ...
  return [{
    [`${componentCls}-root`]: {
      ...
      [`${componentCls}-mask`]: (0, _extends2.default)((0, _extends2.default)({}, box('fixed')), {
      ...
      [`${componentCls}-wrap`]: (0, _extends2.default)((0, _extends2.default)({}, box('fixed')), {
        overflow: 'auto',
        outline: 0,
...
const genModalStyle = token => {
  ...
  // ======================== Modal ========================
  {
    [componentCls]: (0, _extends2.default)((0, _extends2.default)({}, (0, _style.resetComponent)(token)), {
      ...
      [`${componentCls}-close`]: (0, _extends2.default)({
        position: 'absolute',
...
const genModalConfirmStyle = token => {
  ...
  return {
    [confirmComponentCls]: {
      ...
      [`${confirmComponentCls}-body-wrapper`]: (0, _extends2.default)({}, (0, _style.clearFix)()),
