...
namespace DB_Backend.DB_BackendBLL
{
    public class TicketsManager
    {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static TicketsResponseModel ReduceOrAddTickets(TicketsReduceOrAddModel model)
        {
            TicketsResponseModel response = new TicketsResponseModel
            {
                Is_success = TicketsServer.ReduceOrAddTickets(model,model.Reduce)
            };
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static TicketsResponseModel PayOrder(PayOrderModel model)
        {
            TicketsResponseModel response = new TicketsResponseModel
            {
                Is_success = TicketsServer.PayOrder(model)
            };
