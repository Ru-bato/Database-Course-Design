    ...
    methods: {
        ...
        async fetchSuggestions(query) {
            try {
                ...
                const response = await axios.post('http://localhost:5097/Question', request, {
                    headers: {
        ...
        async getQuestionBackend() {
            try {
                const response = await axios.get('http://localhost:5097/Question');
